function clk()
{
    ...
    switch(dy)
    {
        ...
        break;
        case 1:dy="Monday"
        bdy.style.backgroundImage="url(monImg.jpg)"
       
        break;
        case 2:dy="Tuesday"
        bdy.style.backgroundImage="url(tueImg.jpg)"
        
        break;
        case 3:dy="Wednesday"
        bdy.style.backgroundImage="url(wedimg.jpg)"
       
        break;
        case 4:dy="Thursday"
        bdy.style.backgroundImage="url(thurimg.jpg)"
       
        break;
        case 5:dy="Friday"
        bdy.style.backgroundImage="url(frimage.jpg)"
...
function greet()
{
    ...
    if(time>=5 && time<=12)
    {
        ...
        document.getElementById("container").style.backgroundColor=" rgba(200, 217, 224, 0.548)"
    ...
    else if(time>=16 && time<20)
    {
        ...
        document.getElementById("container").style.backgroundColor="rgba(0, 0, 0, 0.604)"
    ...
    else
    {
        ...
        document.getElementById("container").style.backgroundColor="rgba(0, 0, 0, 0.684)"
        document.getElementById("Time").style.color="white"
        document.getElementById("Date").style.color="wheat"
        document.getElementById("Day").style.color="wheat"
        document.getElementById("Seconds").style.color="black"
...
setTimeout( removeTheGreetWindow,3000)
